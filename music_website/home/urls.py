...
urlpatterns = [
    ...
    path('mycollections/<int:collection_id>/delete', views.delete_collection, name='delete_collection'),
    ...
    path('staffpick/<int:pick_id>/view', views.staff_pick_view, name='staff_pick_view'),
